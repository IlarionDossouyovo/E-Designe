      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
            <Link to="/products?cat=Bebe&qual=Premium" style={{ padding: '12px 24px', background: '#fff', color: '#ff9f43', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold' }}>Premium</Link>
