      ...
      <div style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
            <Link to="/products?cat=Femme&qual=Premium" style={{ padding: '12px 24px', background: '#fff', color: '#c71585', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold' }}>Premium</Link>
            <Link to="/products?cat=Femme" style={{ padding: '12px 24px', background: 'rgba(255,255,255,0.2)', color: '#fff', borderRadius: '8px', textDecoration: 'none' }}>Voir tout</Link>
          </div>
        </div>
