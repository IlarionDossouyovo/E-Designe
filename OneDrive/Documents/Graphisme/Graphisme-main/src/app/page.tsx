...
const Navbar = () => {
  ...
  const navItems = [
    { name: 'Accueil', href: '/' },
    { name: 'AI Portfolio', href: '/ai-portfolio' },
    { name: 'AI Studio', href: '/ai-studio' },
    { name: 'AI Projects', href: '/ai-project-manager' },
    { name: 'Équipe IA', href: '/ai-team' },
    { name: 'Commandes', href: '/founder-command' },
    { name: 'AI Center', href: '/founder-ai-center' },
  ...
  const navItemsMobile = [
    ...
    { name: 'Annonces', href: '/announcements' },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a href="/ai-portfolio" className="glass-button text-lg glow-gold">
              <span className="flex items-center justify-center gap-2">
                🎨 AI Portfolio <ArrowRight className="w-5 h-5" />
              </span>
            </a>
            <a href="#services" className="px-8 py-4 rounded-xl font-semibold border border-gold/30 text-gold hover:bg-gold/10 transition-all flex items-center justify-center gap-2">
...
const Portfolio = () => {
  const [projects, setProjects] = useState([
    { title: 'Logo Premium', category: 'Design', image: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=800&h=600&fit=crop' },
    { title: 'Site E-commerce', category: 'Développement', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop' },
    { title: 'Application Mobile', category: 'Mobile', image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800&h=600&fit=crop' },
    { title: 'Branding Complete', category: 'Identité', image: 'https://images.unsplash.com/photo-1634942537034-2531766767d1?w=800&h=600&fit=crop' },
    { title: 'Video Marketing', category: 'Vidéo', image: 'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=800&h=600&fit=crop' },
    { title: 'Dashboard ERP', category: 'SaaS', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop' },
  ])
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, i) => (
            <Link key={i} href="/portfolio">
              ...
              >
                <div className="h-64 bg-gradient-to-br from-premium-card to-premium-dark flex items-center justify-center overflow-hidden group-hover:scale-110 transition-transform duration-500">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              {/* TikTok */}
              <a href="https://tiktok.com/@electron" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-gray-400 hover:text-gold hover:bg-gold/10 transition-all">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
              </a>
              {/* YouTube */}
              <a href="https://youtube.com/@electron" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-gray-400 hover:text-gold hover:bg-gold/10 transition-all">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              {/* WhatsApp */}
              <a href="https://wa.me/22900000000" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-gray-400 hover:text-gold hover:bg-gold/10 transition-all">
