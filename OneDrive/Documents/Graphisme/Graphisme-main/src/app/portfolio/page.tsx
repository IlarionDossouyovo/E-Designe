...
import { ArrowLeft, ExternalLink, Github, Figma, Palette, Code, Smartphone, Brain, Video, ShoppingCart, Home } from 'lucide-react'
...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-premium-black">
      ...
      {/* Navigation */}
      <div className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto pt-20">
