...
import { 
  ...
  Zap, Play, Pause, ArrowLeft, Plus, Trash2, Edit, Save, Gift, Home
} from 'lucide-react'
...
const Sidebar = ({ activeTab, setActiveTab }: { activeTab: string; setActiveTab: (tab: string) => void }) => {
  const menuItems = [
    ...
    { id: 'marketing', icon: BarChart3, label: 'Marketing', href: '/admin/social' },
    { id: 'analytics', icon: Activity, label: 'Analytics', href: '/admin/analytics' },
    { id: 'ai-agents', icon: Bot, label: 'Agents IA', href: '/admin/ai-agents' },
    { id: 'automation', icon: Zap, label: 'Automatisations', href: null },
    { id: 'affiliation', icon: Gift, label: 'Affiliation', href: '/admin/affiliation' },
    { id: 'support', icon: MessageSquare, label: 'Support', href: null },
    { id: 'settings', icon: Settings, label: 'Paramètres API', href: '/admin/settings' },
  ]
