...
export default function Fondacteure() {
  const navigate = useNavigate()
  const [activeTab, setActiveTab] = useState('story')

  const quickLinks = [
    { name: 'Accueil', icon: '🏠', path: '/', color: '#4B6CB7' },
    { name: 'Admin', icon: '⚙️', path: '/admin', color: '#25D366' },
    { name: 'Produits', icon: '🛍️', path: '/products', color: '#E4405F' },
    { name: 'Marketing', icon: '📊', path: '/marketing', color: '#F59E0B' },
    { name: 'Textile', icon: '🧵', path: '/textile', color: '#7C3AED' },
  ];

  return (
    <div style={{ padding: '100px 20px 40px', background: '#0a0a0f', minHeight: '100vh' }}>
